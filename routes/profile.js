...
const { fetchProfile, updateProfile, uploadProfilePhoto, updateProfileVisibility, viewAllProfilesForAdmin, listPublicProfiles, deleteUser } = require('../controllers/profile.controller');
...
router.delete('/me/delete', authenticate, deleteUser);
